...
2 [Описание системы](#Описание_системы)
...
Автоматические АЗС чаще всего принимают от трех до 4 видов номиналов, выбираются самые распространенные. Новая система позволяет использовать любой вид номинала, в том числе и монеты.
...
***
## 2 Описание системы <a name="Описание_системы"></a>
***
