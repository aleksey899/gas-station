...
~~~      
 ...
 После создания папки репозитория, было создано хранилище для сущности Car.
...
В качестве тестирования информационной системы была выполнена проверка работы контроллеров в Swagger UI. Это изображено на рисунке 7. 
...
1. С помощью операции Create можно создавать новые записи в таблице. Это показано на рисунке 8.

![alt text](Screen/6.png)
Рисунок 8 - Реализация операции Create

Создание записи о некотором автомобиле на рисунке 9.
...
2. Метод Read позволяет считать значение записи, выбранной по определенному критерию. Это показано на рисунке 11.

![alt text](Screen/9.png)
Рисунок 11 - Реализация операции Read 

Реализация чтения информации об автомобиле с ID=1 представлена на рисунке 12.
...
3. Операция Update, представленная на рисунке 14, позволяет изменить запись.

![alt text](Screen/12.png) 
Рисунок 14 - Реализация операции Update

Изменение марки автомобиля показано на рисунке 15.

![alt text](Screen/13.png)
Рисунок 15 - Редактирование записи

На рисунке 16 показан результат операции Update.

![alt text](Screen/14.png)
Рисунок 16 - Результат операции Update

4. Метод Delete удаляет записи. В случае успешного удаления выводится true, иначе - false. Его реализация представлена на рисунке 17.

![alt text](Screen/15.png)
Рисунок 17 - Реализация метода Delete

Удаление записи об автомобиле показано на рисунке 18.
